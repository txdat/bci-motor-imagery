...
class Inlet:
    ...
    def __init__(self, info: pylsl.StreamInfo, plot_duration: int):
...
class DataInlet(Inlet):
    ...
    def __init__(self, info: pylsl.StreamInfo, plot_duration: int, plt: pg.PlotItem):
...
def receive_and_plot(
    ...
    for info in streams:
        if info.type() == "Markers":
            ...
            inlets.append(DataInlet(info, plot_duration, plt))
        else:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--plot_duration", type=int, default=5, help="how many seconds of data to show"
    )
    parser.add_argument(
        "--update_interval", type=int, default=60, help="ms between screen updates"
    )
    parser.add_argument(
        "--pull_interval", type=int, default=500, help="ms between each pull operation"
    )
    arg = parser.parse_args()

    receive_and_plot(arg.plot_duration, arg.update_interval, arg.pull_interval)
